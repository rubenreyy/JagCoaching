...
class CloudDBController:
    def __init__(self):
        ...
        self.uri = os.getenv("MONGO_URI", f"mongodb+srv://chnast01:{db_cloud_password}@cluster0.i148f.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
class CloudDBInitializer(CloudDBController):
    ...
    def create_collections_and_indexes(self):
        ...
        videos_collection.create_index("user_id")  # For faster queries on user's videos
